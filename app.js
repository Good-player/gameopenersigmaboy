    ...
    {page==="school"&&<div style={{...S.body,maxWidth:700,margin:"0 auto"}}>
      ...
      <div style={{background:"#0d1117",border:"1px solid #1e2430",borderRadius:12,padding:"clamp(12px,3vw,18px)"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          ...
          <button onClick={()=>{setSchoolData(null);setSchoolLoading(true);api("/school/menu",{slug:"turebergsskolan"}).then(r=>{setSchoolData(r||{weeks:[]});setSchoolLoading(false)})}} style={{...S.btn,background:"#ffffff08",color:"#888",fontSize:9}}>Refresh</button>
        </div>
